...
void setup() {
  ...
  background(255);                   // set the background color of window
  MidiBus.list();                  // list all available Midi devices
  bus = new MidiBus(this, 1, 2);   // tell MidiBus to listen to connected MIDI instrument
...
void noteOn(int channel, int pitch, int velocity) {
  // Receive a noteOn
  println("Note On : " + "Cha:" + channel + " " + "Pit:" + pitch + " " + "Vel:" + velocity);
...
void noteOff(int channel, int pitch, int velocity) {
  // Receive a noteOn
  println("Note Off: " + "Cha:" + channel + " " + "Pit:" + pitch + " " + "Vel:" + velocity);
